                            ...
                            <div class="select-options">
                                <div class="page-view-filter">
                                    <div class="dropdown select-featured">
                                        <select class="form-select" name="orderby" id="orderby">
                                            <option value="-1" {{ $size==-1 ? 'selected' :'' }}>Default</option>
                                            <option value="1" {{ $size==1 ? 'selected' :'' }}>Date, New To Old</option>
                                            <option value="2" {{ $size==2 ? 'selected' :'' }}>Date, Old To New</option>
                                            <option value="3" {{ $size==3 ? 'selected' :'' }}>Price, Low To High
                                            </option>
                                            <option value="4" {{ $size==4 ? 'selected' :'' }}>Price, High To Low
                                            </option>
                                        </select>
                                    </div>
                                </div>
                                <div class="dropdown select-featured">
                                    <select class="form-select" name="size" id="pagesize">
                                        ...
                                        <option value="100" {{ $size==100 ? 'selected' :'' }}>100 Products Per Page
                                        </option>
                                    </select>
                                </div>
                            </div>
